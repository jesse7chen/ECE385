...
(
    ...
    localparam PAD12 = log2ceil(64'h20d8 - 64'h20d0); 
    ...
    // ( 0x2030 .. 0x2040 )
    if ( {address[RG:PAD2],{PAD2{1'b0}}} == 29'h2030   ) begin
            src_channel = 14'b10000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x2040 .. 0x2050 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 29'h2040   ) begin
    ...
    // ( 0x2080 .. 0x2090 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 29'h2080   ) begin
            src_channel = 14'b00000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x2090 .. 0x20a0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 29'h2090  && read_transaction  ) begin
            src_channel = 14'b00000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x20a0 .. 0x20b0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 29'h20a0  && read_transaction  ) begin
            src_channel = 14'b00000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x20b0 .. 0x20c0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 29'h20b0   ) begin
            src_channel = 14'b00000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x20c8 .. 0x20d0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 29'h20c8   ) begin
            src_channel = 14'b00000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x20d0 .. 0x20d8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h20d0  && read_transaction  ) begin
