...
module nios_system_mm_interconnect_0 (
		...
		input  wire [28:0] nios_system_data_master_address,               //                 nios_system_data_master.address
		...
		input  wire [28:0] nios_system_instruction_master_address,        //          nios_system_instruction_master.address
	...
	wire   [28:0] nios_system_data_master_translator_avalon_universal_master_0_address;              // nios_system_data_master_translator:uav_address -> nios_system_data_master_agent:av_address
	...
	wire  [106:0] rsp_mux_src_data;                                                                  // rsp_mux:src_data -> nios_system_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                 // nios_system_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [10:0] rsp_mux_src_channel;                                                               // rsp_mux:src_channel -> nios_system_data_master_agent:rp_channel
	...
	wire   [28:0] nios_system_instruction_master_translator_avalon_universal_master_0_address;       // nios_system_instruction_master_translator:uav_address -> nios_system_instruction_master_agent:av_address
	...
	wire  [106:0] rsp_mux_001_src_data;                                                              // rsp_mux_001:src_data -> nios_system_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                             // nios_system_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire   [10:0] rsp_mux_001_src_channel;                                                           // rsp_mux_001:src_channel -> nios_system_instruction_master_agent:rp_channel
	...
	wire   [28:0] nios_system_debug_mem_slave_agent_m0_address;                                      // nios_system_debug_mem_slave_agent:m0_address -> nios_system_debug_mem_slave_translator:uav_address
	...
	wire  [107:0] nios_system_debug_mem_slave_agent_rf_source_data;                                  // nios_system_debug_mem_slave_agent:rf_source_data -> nios_system_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [107:0] nios_system_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios_system_debug_mem_slave_agent_rsp_fifo:out_data -> nios_system_debug_mem_slave_agent:rf_sink_data
	...
	wire  [106:0] cmd_mux_002_src_data;                                                              // cmd_mux_002:src_data -> nios_system_debug_mem_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                             // nios_system_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [10:0] cmd_mux_002_src_channel;                                                           // cmd_mux_002:src_channel -> nios_system_debug_mem_slave_agent:cp_channel
	...
	wire   [10:0] cmd_mux_005_src_channel;                                                           // cmd_mux_005:src_channel -> led_s1_agent:cp_channel
	...
	wire          cmd_mux_009_src_valid;                                                             // cmd_mux_009:src_valid -> to_sw_port_s1_agent:cp_valid
	wire  [106:0] cmd_mux_009_src_data;                                                              // cmd_mux_009:src_data -> to_sw_port_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                             // to_sw_port_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [10:0] cmd_mux_009_src_channel;                                                           // cmd_mux_009:src_channel -> to_sw_port_s1_agent:cp_channel
	wire          cmd_mux_009_src_startofpacket;                                                     // cmd_mux_009:src_startofpacket -> to_sw_port_s1_agent:cp_startofpacket
	wire          cmd_mux_009_src_endofpacket;                                                       // cmd_mux_009:src_endofpacket -> to_sw_port_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_010_src_valid;                                                             // cmd_mux_010:src_valid -> to_sw_sig_s1_agent:cp_valid
	wire  [106:0] cmd_mux_010_src_data;                                                              // cmd_mux_010:src_data -> to_sw_sig_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                             // to_sw_sig_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [10:0] cmd_mux_010_src_channel;                                                           // cmd_mux_010:src_channel -> to_sw_sig_s1_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                                     // cmd_mux_010:src_startofpacket -> to_sw_sig_s1_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                       // cmd_mux_010:src_endofpacket -> to_sw_sig_s1_agent:cp_endofpacket
	wire          nios_system_data_master_agent_cp_valid;                                            // nios_system_data_master_agent:cp_valid -> router:sink_valid
	wire  [106:0] nios_system_data_master_agent_cp_data;                                             // nios_system_data_master_agent:cp_data -> router:sink_data
	...
	wire  [106:0] nios_system_instruction_master_agent_cp_data;                                      // nios_system_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [106:0] nios_system_debug_mem_slave_agent_rp_data;                                         // nios_system_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire          to_sw_port_s1_agent_rp_valid;                                                      // to_sw_port_s1_agent:rp_valid -> router_011:sink_valid
	wire  [106:0] to_sw_port_s1_agent_rp_data;                                                       // to_sw_port_s1_agent:rp_data -> router_011:sink_data
	wire          to_sw_port_s1_agent_rp_ready;                                                      // router_011:sink_ready -> to_sw_port_s1_agent:rp_ready
	wire          to_sw_port_s1_agent_rp_startofpacket;                                              // to_sw_port_s1_agent:rp_startofpacket -> router_011:sink_startofpacket
	wire          to_sw_port_s1_agent_rp_endofpacket;                                                // to_sw_port_s1_agent:rp_endofpacket -> router_011:sink_endofpacket
	...
	wire          to_sw_sig_s1_agent_rp_valid;                                                       // to_sw_sig_s1_agent:rp_valid -> router_012:sink_valid
	wire  [106:0] to_sw_sig_s1_agent_rp_data;                                                        // to_sw_sig_s1_agent:rp_data -> router_012:sink_data
	wire          to_sw_sig_s1_agent_rp_ready;                                                       // router_012:sink_ready -> to_sw_sig_s1_agent:rp_ready
	wire          to_sw_sig_s1_agent_rp_startofpacket;                                               // to_sw_sig_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          to_sw_sig_s1_agent_rp_endofpacket;                                                 // to_sw_sig_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire  [106:0] cmd_demux_001_src8_data;                                                           // cmd_demux_001:src8_data -> cmd_mux_009:sink1_data
	...
	wire  [106:0] cmd_demux_001_src9_data;                                                           // cmd_demux_001:src9_data -> cmd_mux_010:sink1_data
	...
	wire  [106:0] rsp_demux_009_src1_data;                                                           // rsp_demux_009:src1_data -> rsp_mux_001:sink8_data
	...
	wire  [106:0] rsp_demux_010_src1_data;                                                           // rsp_demux_010:src1_data -> rsp_mux_001:sink9_data
	...
	wire          to_hw_port_s1_agent_rdata_fifo_src_valid;                                          // to_hw_port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] to_hw_port_s1_agent_rdata_fifo_src_data;                                           // to_hw_port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          to_hw_port_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_007:in_0_ready -> to_hw_port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                 // avalon_st_adapter_007:out_0_valid -> to_hw_port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                  // avalon_st_adapter_007:out_0_data -> to_hw_port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                 // to_hw_port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                 // avalon_st_adapter_007:out_0_error -> to_hw_port_s1_agent:rdata_fifo_sink_error
	...
	wire          to_sw_port_s1_agent_rdata_fifo_src_valid;                                          // to_sw_port_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_009:in_0_valid
	wire   [33:0] to_sw_port_s1_agent_rdata_fifo_src_data;                                           // to_sw_port_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_009:in_0_data
	wire          to_sw_port_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_009:in_0_ready -> to_sw_port_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_009_out_0_valid;                                                 // avalon_st_adapter_009:out_0_valid -> to_sw_port_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_009_out_0_data;                                                  // avalon_st_adapter_009:out_0_data -> to_sw_port_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_009_out_0_ready;                                                 // to_sw_port_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_009:out_0_ready
	wire    [0:0] avalon_st_adapter_009_out_0_error;                                                 // avalon_st_adapter_009:out_0_error -> to_sw_port_s1_agent:rdata_fifo_sink_error
	wire          to_sw_sig_s1_agent_rdata_fifo_src_valid;                                           // to_sw_sig_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] to_sw_sig_s1_agent_rdata_fifo_src_data;                                            // to_sw_sig_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          to_sw_sig_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_010:in_0_ready -> to_sw_sig_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                                 // avalon_st_adapter_010:out_0_valid -> to_sw_sig_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                  // avalon_st_adapter_010:out_0_data -> to_sw_sig_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                                 // to_sw_sig_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                                 // avalon_st_adapter_010:out_0_error -> to_sw_sig_s1_agent:rdata_fifo_sink_error
	...
	nios_system_mm_interconnect_0_cmd_mux_001 cmd_mux_010 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (nios_system_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_rsp_demux_001 rsp_demux_010 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (nios_system_reset_reset_bridge_in_reset_reset), // clk_reset.reset
