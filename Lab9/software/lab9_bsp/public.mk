...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../lab9.jdi
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20d0
SOPC_SYSID_FLAG += --sidp=0x20d0
ELF_PATCH_FLAG  += --sidp 0x20d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1490150232
SOPC_SYSID_FLAG += --timestamp=1490150232
ELF_PATCH_FLAG  += --timestamp 1490150232
