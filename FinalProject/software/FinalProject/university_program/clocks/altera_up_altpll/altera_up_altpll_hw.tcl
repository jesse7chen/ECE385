...
set_parameter_property type AFFECTS_ELABORATION true
...
set_parameter_property video_out AFFECTS_ELABORATION true
...
set_interface_property outclk0 clockRateKnown true
...
set_interface_property outclk1 clockRateKnown true
...
set_interface_property outclk2 clockRateKnown true
...
proc elaborate {} {
	...
	if { $type == "Video" } {
		set_interface_property outclk0 clockRate 25000000
		set_interface_property outclk1 clockRate 25000000
		if { $video_out == "8\" LCD on TPad/VEEK" } {
			set_interface_property outclk2 clockRate 40000000
		} elseif { $video_out == "7\" LCD on VEEK-MT and MTL Module" } {
			set_interface_property outclk2 clockRate 33300000
		} else {
			set_interface_property outclk2 clockRate 25000000
		}
		
	} elseif { $type == "Audio" } {
		set_interface_property outclk0 clockRate [ expr $audio_clk_freq * 1000000 ]
		set_interface_property outclk1 clockRate 50000000
		set_interface_property outclk2 clockRate 50000000

	} else {
		set_interface_property outclk0 clockRate 50000000
		set_interface_property outclk1 clockRate 50000000
		set_interface_property outclk2 clockRate 50000000
	}
}
