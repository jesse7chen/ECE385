...
create_driver avalon_de0_nano_adc_driver

# Associate it with some hardware
set_sw_property hw_class_name altera_up_avalon_de0_nano_adc

# The version of this driver
set_sw_property version $aup_version

# This driver is proclaimed to be compatible with 'component'
# as old as version "4.0". The component hardware version is set in the 
...
# C/C++ source files
add_sw_property c_source HAL/src/altera_up_avalon_de0_nano_adc.c

# Include files
add_sw_property include_source HAL/inc/altera_up_avalon_de0_nano_adc.h
add_sw_property include_source HAL/inc/altera_up_avalon_de0_nano_adc_regs.h
