...
# 
set_module_property DESCRIPTION "ADC Controller for Altera DE1-SoC Board"
set_module_property NAME altera_up_avalon_de1_soc_adc_mega
...
set_module_property DISPLAY_NAME "DE1-SoC ADC Controller"
set_module_property DATASHEET_URL "[pwd]/doc/DE1-SoC_ADC_Controller.pdf"
...
# | files
# | 
add_file "hdl/altera_up_avalon_de1_soc_adv_adc.v" {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
set_parameter_property tsclk HDL_PARAMETER true


add_parameter numch_ INTEGER 8 ""
set_parameter_property numch_ DISPLAY_NAME "Number of Channels Used (1 to 8)"
set_parameter_property numch_ TYPE INTEGER
set_parameter_property numch_ UNITS None
set_parameter_property numch_ ALLOWED_RANGES 1:8
set_parameter_property numch_ DESCRIPTION ""
set_parameter_property numch_ AFFECTS_ELABORATION true
set_parameter_property numch_ AFFECTS_GENERATION true
set_parameter_property numch_ VISIBLE true
set_parameter_property numch_ ENABLED true

add_parameter numch INTEGER 
set_parameter_property numch DISPLAY_NAME "Number of Channels Used - 1"
...
set_parameter_property numch VISIBLE false
set_parameter_property numch ENABLED true
set_parameter_property numch DERIVED true
set_parameter_property numch HDL_PARAMETER true
...
proc elaborate {} {
    ...
    set num_ch [ get_parameter_value "numch_" ]
    set_parameter_value numch [ expr {$num_ch - 1} ]
}
	
proc generate {} {
	send_message info "Starting Generation of DE1-SoC ADC Controller"
	
	set num_ch [ get_parameter_value "numch" ]
	set t_sclk [ get_parameter_value "tsclk" ]
	
	set tsclk_p [ format "tsclk:8'd%d" $t_sclk ]
	set numch_p [ format "numch:3'd%d" $num_ch ]
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_de1_soc_adc_mega.v" "altera_up_avalon_de1_soc_adc_mega" $dest_name $params $sections
