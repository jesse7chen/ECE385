...
set_module_property DATASHEET_URL "[pwd]/doc/Accelerometer_SPI_Mode.pdf"
...
# | 
add_interface avalon_accelerometer_spi_mode_slave avalon end 
set_interface_property avalon_accelerometer_spi_mode_slave addressAlignment DYNAMIC
set_interface_property avalon_accelerometer_spi_mode_slave associatedClock clk
set_interface_property avalon_accelerometer_spi_mode_slave associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_accelerometer_spi.v" "altera_up_avalon_accelerometer_spi" $dest_name $params $sections
