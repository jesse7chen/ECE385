...
set_module_property DATASHEET_URL "[pwd]/doc/PS2_Controller.pdf"
...
proc elaborate {} {
	...
	if { $avalon_bus_type == "Memory Mapped" } {
		...
		set_interface_property avalon_ps2_slave associatedClock clk
		set_interface_property avalon_ps2_slave associatedReset reset
		...
		# | 
		add_interface avalon_ps2_command_sink avalon_streaming end 
		set_interface_property avalon_ps2_command_sink associatedClock clk
		set_interface_property avalon_ps2_command_sink associatedReset reset
		...
		# | 
		add_interface avalon_ps2_data_source avalon_streaming start
		set_interface_property avalon_ps2_data_source associatedClock clk
		set_interface_property avalon_ps2_data_source associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# add_file "$dest_dir/altera_up_ps2.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_ps2_command_out.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_ps2_data_in.v" SYNTHESIS

	# Generate HDL
	if { $avalon_bus_type == "Memory Mapped" } {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_mm_ps2.v" "altera_up_avalon_mm_ps2" $dest_name $params $sections
	} else {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_st_ps2.v" "altera_up_avalon_st_ps2" $dest_name $params $sections
	}
