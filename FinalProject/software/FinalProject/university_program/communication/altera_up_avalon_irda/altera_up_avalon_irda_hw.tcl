...
# +-----------------------------------
# | module altera_up_avalon_irda
# | 
set_module_property DESCRIPTION "IrDA UART Controller"
set_module_property NAME altera_up_avalon_irda
...
set_module_property DISPLAY_NAME "IrDA UART"
set_module_property DATASHEET_URL "[pwd]/doc/IrDA.pdf"
#set_module_property TOP_LEVEL_HDL_FILE altera_up_avalon_irda.v
#set_module_property TOP_LEVEL_HDL_MODULE altera_up_avalon_irda
...
# | files
# | 
#add_file altera_up_avalon_irda.v {SYNTHESIS SIMULATION}
add_file "hdl/altera_up_irda_counters.v" {SYNTHESIS SIMULATION}
add_file "hdl/altera_up_irda_in_deserializer.v" {SYNTHESIS SIMULATION}
add_file "hdl/altera_up_irda_out_serializer.v" {SYNTHESIS SIMULATION}
...
proc elaborate {} {
	...
	if { $avalon_bus_type == "Memory Mapped" } {
		# +-----------------------------------
		# | connection point avalon_irda_slave
		# | 
		add_interface avalon_irda_slave avalon end
		set_interface_property avalon_irda_slave addressAlignment DYNAMIC
		set_interface_property avalon_irda_slave associatedClock clk
		set_interface_property avalon_irda_slave associatedReset reset
		set_interface_property avalon_irda_slave bridgesToMaster ""
		set_interface_property avalon_irda_slave burstOnBurstBoundariesOnly false
		#set_interface_property avalon_irda_slave explicitAddressSpan 8
		set_interface_property avalon_irda_slave holdTime 0
		set_interface_property avalon_irda_slave isBigEndian  false
		set_interface_property avalon_irda_slave isFlash false
		set_interface_property avalon_irda_slave isMemoryDevice false
		set_interface_property avalon_irda_slave isNonVolatileStorage false
		set_interface_property avalon_irda_slave linewrapBursts false
		set_interface_property avalon_irda_slave maximumPendingReadTransactions 0
		set_interface_property avalon_irda_slave minimumUninterruptedRunLength 1
		set_interface_property avalon_irda_slave printableDevice false
		set_interface_property avalon_irda_slave readLatency 1
		set_interface_property avalon_irda_slave readWaitTime 0
		set_interface_property avalon_irda_slave setupTime 0
		set_interface_property avalon_irda_slave timingUnits cycles
		set_interface_property avalon_irda_slave writeWaitTime 0

		add_interface_port avalon_irda_slave address address Input 1
		add_interface_port avalon_irda_slave chipselect chipselect Input 1
		add_interface_port avalon_irda_slave byteenable byteenable Input 4
		add_interface_port avalon_irda_slave read read Input 1
		add_interface_port avalon_irda_slave write write Input 1
		add_interface_port avalon_irda_slave writedata writedata Input 32
		add_interface_port avalon_irda_slave readdata readdata Output 32
		# | 
		# +-----------------------------------
		...
		set_interface_property interrupt associatedAddressablePoint avalon_irda_slave
	...
	add_interface_port external_interface IRDA_TXD export Output 1
	add_interface_port external_interface IRDA_RXD export Input 1
	# | 
	# +-----------------------------------
}
# | 
...
proc generate {} {
	...
	set baud_tick_count				[ format "BAUD_TICK_COUNT:$counter_width'd%.0f" [ expr $clk_rate / $baud ] ]
	set half_baud_tick_increment	[ format "HALF_BAUD_TICK_COUNT:$counter_width'd%.0f" [ expr $clk_rate / ($baud * 2) ] ]
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# add_file "$dest_dir/altera_up_irda_counters.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_irda_in_deserializer.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_irda_out_serializer.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_sync_fifo.v" SYNTHESIS

	# Generate HDL
	if { $avalon_bus_type == "Memory Mapped" } {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_mm_irda.v" "altera_up_avalon_mm_irda" $dest_name $params $sections
	} else {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_st_irda.v" "altera_up_avalon_st_irda" $dest_name $params $sections
	}
	# file copy -force "hdl/altera_up_irda_counters.v" $dest_dir
	# file copy -force "hdl/altera_up_irda_in_deserializer.v" $dest_dir
	# file copy -force "hdl/altera_up_irda_out_serializer.v" $dest_dir
