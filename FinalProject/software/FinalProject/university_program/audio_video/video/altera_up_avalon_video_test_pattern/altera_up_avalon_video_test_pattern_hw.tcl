...
# | 
add_interface avalon_generator_source avalon_streaming start 
set_interface_property avalon_generator_source associatedClock clk
set_interface_property avalon_generator_source associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_test_pattern.v" "altera_up_avalon_video_test_pattern" $dest_name $params $sections
