...
set_interface_property avalon_char_control_slave associatedClock clk
set_interface_property avalon_char_control_slave associatedReset reset
...
set_interface_property avalon_char_buffer_slave associatedClock clk
set_interface_property avalon_char_buffer_slave associatedReset reset
...
set_interface_property avalon_char_source associatedClock clk
set_interface_property avalon_char_source associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# add_file "$dest_dir/altera_up_video_128_character_rom.v" SYNTHESIS
	# add_file "$dest_dir/altera_up_video_fb_color_rom.v" SYNTHESIS
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_character_buffer_with_dma.v" "altera_up_avalon_video_character_buffer_with_dma" $dest_name $params $sections
	# file copy -force "hdl/altera_up_video_128_character_rom.v" $dest_dir
	# file copy -force "hdl/altera_up_video_fb_color_rom.v" $dest_dir
