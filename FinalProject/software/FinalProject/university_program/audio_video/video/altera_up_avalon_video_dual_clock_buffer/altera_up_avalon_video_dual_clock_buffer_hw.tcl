...
set_interface_property clock_stream_in enabled true
...
# +-----------------------------------
# | connection point reset_stream_in
# | 
add_interface reset_stream_in reset end
set_interface_property reset_stream_in associatedClock clock_stream_in
set_interface_property reset_stream_in enabled true
set_interface_property reset_stream_in synchronousEdges DEASSERT

add_interface_port reset_stream_in reset_stream_in reset Input 1
# | 
# +-----------------------------------
...
set_interface_property clock_stream_out enabled true
...
# +-----------------------------------
# | connection point reset_stream_out
# | 
add_interface reset_stream_out reset end
set_interface_property reset_stream_out associatedClock clock_stream_out
set_interface_property reset_stream_out enabled true
set_interface_property reset_stream_out synchronousEdges DEASSERT

add_interface_port reset_stream_out reset_stream_out reset Input 1
# | 
# +-----------------------------------
...
# | 
add_interface avalon_dc_buffer_sink avalon_streaming end 
set_interface_property avalon_dc_buffer_sink associatedClock clock_stream_in
set_interface_property avalon_dc_buffer_sink associatedReset reset_stream_in
...
# | 
add_interface avalon_dc_buffer_source avalon_streaming start
set_interface_property avalon_dc_buffer_source associatedClock clock_stream_out
set_interface_property avalon_dc_buffer_source associatedReset reset_stream_out
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_dual_clock_buffer.v" "altera_up_avalon_video_dual_clock_buffer" $dest_name $params $sections
}
# | 
# +-----------------------------------
