...
# | 
add_interface avalon_chroma_sink avalon_streaming end
set_interface_property avalon_chroma_sink associatedClock clk
set_interface_property avalon_chroma_sink associatedReset reset
...
set_interface_property avalon_chroma_source associatedClock clk
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_chroma_resampler.v" "altera_up_avalon_video_chroma_resampler" $dest_name $params $sections
}
# | 
# +-----------------------------------
