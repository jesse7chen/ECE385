...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	if { $router_type == "Split" } {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_stream_splitter.v" "altera_up_avalon_video_stream_splitter" $dest_name $params $sections
	} else {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_stream_merger.v" "altera_up_avalon_video_stream_merger" $dest_name $params $sections
	}
