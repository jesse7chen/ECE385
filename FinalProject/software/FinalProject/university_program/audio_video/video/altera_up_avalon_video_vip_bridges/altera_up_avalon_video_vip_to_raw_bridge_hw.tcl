...
# | 
add_interface avalon_vip_to_raw_sink avalon_streaming end 
set_interface_property avalon_vip_to_raw_sink associatedClock clk
set_interface_property avalon_vip_to_raw_sink associatedReset reset
...
# | 
add_interface avalon_vip_to_raw_source avalon_streaming start 
set_interface_property avalon_vip_to_raw_source associatedClock clk
set_interface_property avalon_vip_to_raw_source associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# Generate HDL
	alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_video_vip_to_raw_bridge.v" "altera_up_avalon_video_vip_to_raw_bridge" $dest_name $params $sections
}
# | 
# +-----------------------------------
