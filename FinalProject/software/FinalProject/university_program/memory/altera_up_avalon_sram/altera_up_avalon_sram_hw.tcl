...
proc elaborate {} {
	...
	if { $board == "DE2-70" } {
		...
		set_interface_property avalon_ssram_slave associatedClock clk
		set_interface_property avalon_ssram_slave associatedReset reset
...
#	set dest_language	[ get_generation_property HDL_LANGUAGE ]
	...
	# generate HDL
	if { $board == "DE2-70" } {
		alt_up_generate "$dest_dir$dest_name.v" "hdl/altera_up_avalon_ssram.v" "altera_up_avalon_ssram" $dest_name $params $sections
	} else {
