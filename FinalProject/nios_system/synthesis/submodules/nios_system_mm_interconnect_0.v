...
module nios_system_mm_interconnect_0 (
	...
	wire   [28:0] audio_and_video_config_0_avalon_av_config_slave_agent_m0_address;                   // audio_and_video_config_0_avalon_av_config_slave_agent:m0_address -> audio_and_video_config_0_avalon_av_config_slave_translator:uav_address
	...
	wire  [106:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // audio_and_video_config_0_avalon_av_config_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [8:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> audio_and_video_config_0_avalon_av_config_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	...
	wire   [28:0] altpll_0_pll_slave_agent_m0_address;                                                // altpll_0_pll_slave_agent:m0_address -> altpll_0_pll_slave_translator:uav_address
	...
	wire  [106:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> altpll_0_pll_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> switch_s1_agent:cp_data
	...
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> key_s1_agent:cp_channel
	...
	wire  [106:0] audio_and_video_config_0_avalon_av_config_slave_agent_rp_data;                      // audio_and_video_config_0_avalon_av_config_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [106:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [106:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [106:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_009:sink_data
	...
	wire          audio_and_video_config_0_avalon_av_config_slave_agent_rdata_fifo_src_valid;         // audio_and_video_config_0_avalon_av_config_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] audio_and_video_config_0_avalon_av_config_slave_agent_rdata_fifo_src_data;          // audio_and_video_config_0_avalon_av_config_slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          audio_and_video_config_0_avalon_av_config_slave_agent_rdata_fifo_src_ready;         // avalon_st_adapter:in_0_ready -> audio_and_video_config_0_avalon_av_config_slave_agent:rdata_fifo_src_ready
	...
	wire          altpll_0_pll_slave_agent_rdata_fifo_src_valid;                                      // altpll_0_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] altpll_0_pll_slave_agent_rdata_fifo_src_data;                                       // altpll_0_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          altpll_0_pll_slave_agent_rdata_fifo_src_ready;                                      // avalon_st_adapter_004:in_0_ready -> altpll_0_pll_slave_agent:rdata_fifo_src_ready
