...
module nios_system_mm_interconnect_1 (
	...
	wire  [104:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // nios2_qsys_0_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> nios2_qsys_0_debug_mem_slave_agent:cp_channel
	...
	wire  [104:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> altpll_0_pll_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // altpll_0_pll_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> altpll_0_pll_slave_agent:cp_channel
	...
	wire  [104:0] nios2_qsys_0_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_0_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [104:0] altpll_0_pll_slave_agent_rp_data;                                                   // altpll_0_pll_slave_agent:rp_data -> router_005:sink_data
	...
	nios_system_mm_interconnect_1_router_003 router_007 (
	...
	nios_system_mm_interconnect_1_router_003 router_009 (
	...
	nios_system_mm_interconnect_1_cmd_mux_001 cmd_mux_005 (
		.clk                 (altpll_0_c0_clk),                         //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_1_cmd_mux_001 cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_1_cmd_mux_001 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_1_rsp_demux_001 rsp_demux_005 (
		.clk                (altpll_0_c0_clk),                         //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_1_rsp_demux_001 rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_1_rsp_demux_001 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
